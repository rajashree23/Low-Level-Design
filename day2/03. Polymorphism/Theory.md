...
Abstraction hides implementation details from the caller by exposing a common interface.

Polymorphism allows different concrete classes to provide their own implementation of that interface.

Instead of using if/else or switch to decide which implementation to call, we can call the method through the common interface.
...
virtual does NOT require = 0.
→ virtual functions can have an implementation.
